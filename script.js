...
const copy = {
	en: {
		...
		lead:
			"LUMA is a new digital experience for thoughtful teams, curious creators, and beautifully ambitious ideas. Join the waitlist and get first access when the beta opens.",
		socialTarget: 3100,
		...
		copyText:
			"I just joined the LUMA private beta waitlist. Take a look at this landing page concept.",
		replay: "Replay Intro",
		skip: "Skip",
		micro:
			"Three visual directions. One shared layout. Switch styles to preview the system.",
		days: "Days",
		hours: "Hours",
		minutes: "Min",
		errors: {
		...
		themes: {
			minimal: {
				...
				panelDescription:
					"A quiet control surface for launches, updates, and early invites.",
				stat1: "Waitlist",
				statValue1: "3.1k",
				stat2: "Launch",
				statValue2: "July",
			...
			retro: {
				...
				panelDescription:
					"Bright signals, fast invites, and playful momentum for the next big reveal.",
				stat1: "Hype",
				statValue1: "97%",
				stat2: "Drop",
				statValue2: "Soon",
			...
			luxury: {
				...
				panelDescription:
					"A refined surface for discreet launches, curated access, and measured anticipation.",
				stat1: "Guests",
				statValue1: "3.1k",
				stat2: "Edition",
				statValue2: "July",
	...
	ro: {
		...
		lead:
			"LUMA este o nouă experiență digitală pentru echipe atente, creatori curioși și idei frumos ambițioase. Intră pe lista de așteptare și obține acces imediat ce beta-ul se deschide.",
		socialTarget: 3100,
		...
		copyText:
			"Tocmai m-am înscris pe lista de așteptare pentru beta-ul privat LUMA. Uite conceptul acestui landing page.",
		replay: "Rulează intro",
		skip: "Sari",
		micro:
			"Trei direcții vizuale. Același layout. Schimbă stilul ca să vezi sistemul.",
		days: "Zile",
		hours: "Ore",
		minutes: "Min",
		errors: {
		...
		themes: {
			minimal: {
				...
				panelDescription:
					"Un spațiu calm pentru lansări, actualizări și invitații timpurii.",
				stat1: "Listă",
				statValue1: "3.1k",
				stat2: "Lansare",
				statValue2: "Iulie",
			...
			retro: {
				...
				panelDescription:
					"Semnale vibrante, invitații rapide și energie bună pentru următorul reveal.",
				stat1: "Buzz",
				statValue1: "97%",
				stat2: "Drop",
				statValue2: "Curând",
			...
			luxury: {
				...
				panelDescription:
					"O suprafață rafinată pentru lansări discrete, acces curatoriat și anticipare controlată.",
				stat1: "Invitați",
				statValue1: "3.1k",
				stat2: "Ediție",
				statValue2: "Iulie",
...
const network = {
	async submitWaitlist(email, meta = {}) {
		if (
			...
			NETWORK_CONFIG.endpoint.includes("example.com")
		) {
